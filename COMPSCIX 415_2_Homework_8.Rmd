...
train_data2 <- train_data %>% mutate(Survived = case_when(
  Survived ==  1 ~'Yes',
  Survived ==  0 ~ 'No' 
))

glimpse(train_data2)
mod_3 <- glm(Survived ~ Pclass + Sex + Fare, data = train_data)
tidy(mod_3)
...
#####ANSWER####
A male passenger who paid a fare less than 26 had low probabity of surving as indicated in Node 3 boxplot.
