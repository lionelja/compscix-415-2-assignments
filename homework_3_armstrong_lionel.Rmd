...
?geom_boxplot
ggplot(data = mpg) + 
  geom_boxplot(mapping = aes(x = class, y=hwy, position="fill"))
ggplot(data = mpg) + 
  geom_boxplot(mapping = aes(x = class, y=hwy, position="dodge"))
ggplot(data = mpg) + 
  geom_boxplot(mapping = aes(x = class, y=hwy, position="jitter"))
ggplot(data = mpg) + 
...
The default class of a variable is character and the character value has to be enclosed in single quotes in assignment statement.
